...
import com.guardianapp.mobile.data.api.ConfirmLinkRequest;
...
public class VerificationActivity extends AppCompatActivity {
    ...
    private void routeAfterActivation() {
        ...
        RetrofitClient.getApiService().getMyFamilyGroups(miIdProtegido).enqueue(new Callback<java.util.List<com.guardianapp.mobile.data.api.FamilyGroupResponse>>() {
            @Override
            public void onResponse(Call<java.util.List<com.guardianapp.mobile.data.api.FamilyGroupResponse>> call, Response<java.util.List<com.guardianapp.mobile.data.api.FamilyGroupResponse>> response) {
            ...
            @Override
            public void onFailure(Call<java.util.List<com.guardianapp.mobile.data.api.FamilyGroupResponse>> call, Throwable t) {
